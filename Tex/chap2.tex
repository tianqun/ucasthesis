...
\begin{figure}[!t]
    ...
    \bicaption{风速趋势不确定性。a）全球，b）北美洲，c）欧洲，d）亚洲。虚线为年均值，实线为虚线的线性趋势。}{Uncertainty in wind speed trends. a)Global, b)North America, c) Europe, d)Asia. Dash line is annual mean value, solid line is linear trend line of dash line.}
...
\subsection{风速年代际变化的不确定性}

\begin{figure}[!b]
    \centering
    \includegraphics[width=0.9\textwidth]{风速年代际变化不确定性}
    \bicaption{风速年代际变化不确定性。a）全球，b）北美洲，c）欧洲，d）亚洲。虚线为年均值，实线为虚线9点平滑后的结果。}{Uncertainty in decadal changes of wind speed trends. a)Global, b)North America, c) Europe, d)Asia. Dash line is annual mean value, soild line is 9-point moving mean of dash line.}
